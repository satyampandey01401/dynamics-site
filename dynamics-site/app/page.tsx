...
export default function Home() {
  ...
  // 4. ANIMATION VARIANTS (Fixed Types & No Duplicates)
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-600 selection:text-white cursor-none">
      ...
      <section className="relative bg-slate-950 overflow-hidden pt-32 pb-32 lg:pt-48 lg:pb-40 flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
            ...
            <motion.h1 variants={fadeUpStagger} className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6 tracking-tight">
            ...
            <motion.p variants={fadeUpStagger} className="text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-slate-50 border border-slate-200 rounded-3xl p-8 lg:p-12 shadow-xl flex flex-col lg:flex-row gap-12 items-center">
            <div className="w-full lg:w-1/2 space-y-10">
              <div>
                ...
                <input type="range" min="50" max="2000" step="50" value={leadsPerMonth} onChange={(e) => setLeadsPerMonth(Number(e.target.value))} className="w-full h-3 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-blue-600" />
              </div>
              <div>
                <div className="flex justify-between mb-2">
                ...
                <input type="range" min="500" max="50000" step="500" value={avgDealSize} onChange={(e) => setAvgDealSize(Number(e.target.value))} className="w-full h-3 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-blue-600" />
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 bg-slate-950 rounded-2xl p-8 text-white shadow-inner relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="border-b border-slate-800 pb-6">
                  <p className="text-slate-400 font-medium mb-1">Projected Revenue with DynamicsPro <Zap className="h-4 w-4 text-blue-400 Inline"/></p>
                ...
                <div className="pt-2">
                  ...
                  <motion.p key={addedMonthlyValue} initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">
          ...
          <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row border border-slate-100">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideRight} className="md:w-5/12 p-12 lg:p-16 bg-blue-600 text-white flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-6 text-base font-medium">
                  <p className="flex items-center gap-4 text-white">📍 Noida, UP</p>
                  <p className="flex items-center gap-4 text-white">📧 solutions@dynamicspro.com</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideLeft} className="md:w-7/12 p-12 lg:p-16 bg-white">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={status === 'loading'} className="w-full bg-slate-900 text-white font-bold text-lg py-5 rounded-xl hover:bg-blue-600 transition-all duration-300 mt-4 disabled:opacity-70">
      ...
      <footer className="bg-slate-950 py-12 border-t border-slate-900 text-center text-slate-500 text-sm">
        <p>© 2026 Satyam Panndey Dynamics Solutions. Built for Scale.</p>
      </footer>
    </div>
  );
}